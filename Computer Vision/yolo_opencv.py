...
In the YOLO v3 architecture we are using there are multiple output layers giving out predictions.
 get_output_layers() function gives the names of the output layers. 
 An output layer is not connected to any next layer.
"""
...
# Extracting the filename without extension from the provided path
image_name = os.path.splitext(os.path.basename(args.image))[0]

output_image_path = f"{image_name}_object_detection.jpg"
