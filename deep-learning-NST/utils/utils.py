...
def prepare_img(img_path, target_shape, device):
    #loads image as numpy array and transform it.
    ...
    #important scale the image to pixel 255 because vgg learns data like that
    #normalization is important too
    ...
    #puts device to cuda in order to copy tensors to gpu 
    #unsqueeze: adds dummy dimension to make it like a batch
    #do this for content and style
    return img
