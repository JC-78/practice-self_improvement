...
image=cv2.imread('/Users/joonghochoi/Desktop/fun/OCR/page1.jpg')
img=image
...
# contours2, hierarchy = cv2.findContours(image, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE) 
# above won't work with just image. Need to apply preprocessing
